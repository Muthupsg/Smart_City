...
import com.mxian.smartcity.LocationUtil.PermissionUtils;
import com.mxian.smartcity.LocationUtil.PermissionUtils.PermissionResultCallback;
...
public class MyLocationUsingLocationAPI extends AppCompatActivity implements ConnectionCallbacks,
    ...
    @BindView(R.id.tvlati)
    TextView tvLati;
    @BindView(R.id.tvlongi)
    TextView tvLongi;
    ...
    /*
    TextView tvLati=(TextView)findViewById(R.id.tvlati);
    TextView tvLongi=(TextView)findViewById(R.id.tvlongi);
*/
   String currentLocation;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gpsimg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (currentLocation != null) {
                    Intent intent = new Intent(MyLocationUsingLocationAPI.this, MapsActivity.class);

                    Bundle c = new Bundle();
                    c.putString("lati", Double.toString(latitude));
                    c.putString("longi", Double.toString(longitude));
                    c.putString("address", currentLocation);
        ...
        btnProceed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                showToast("Proceed to the next step");
                Intent intent = new Intent(MyLocationUsingLocationAPI.this, ReportActivity.class);
    ...
    private class GeocoderHandler extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            tvLongi.setText("Longitude: "+Double.toString(longitude));
